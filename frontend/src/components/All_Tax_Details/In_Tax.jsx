            ...
            <div className='col-md-6'>
                <div className="card my-3 card-sh">
                    <div className="card-body m-auto">
                        ...
                        <h5 className="card-text"><span className='tax-title'>House Rate : </span> <span className='tax-value'>{tax.bas} <span className='rs-tag'>Rs</span></span></h5>
                        <h5 className="card-text"><span className='tax-title'>Water Tax : </span> <span className='tax-value'>{tax.lta} <span className='rs-tag'>Rs</span></span></h5>
                        <h5 className="card-text"><span className='tax-title'>Electric tax : </span> <span className='tax-value'>{tax.hra} <span className='rs-tag'>Rs</span></span></h5>
                        <h5 className="card-text"><span className='tax-title'>Land Tax : </span> <span className='tax-value'>{tax.fa} <span className='rs-tag'>Rs</span></span></h5>
                        <h5 className="card-text"><span className='tax-title'>Buissnes tax: </span> <span className='tax-value'>{tax.inv} <span className='rs-tag'>Rs</span></span></h5>
                        <h5 className="card-text"><span className='tax-title'>Medical Policy Premium : </span> <span className='tax-value'>{tax.med} <span className='rs-tag'>Rs</span></span></h5>
